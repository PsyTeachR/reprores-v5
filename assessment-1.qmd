...
* [ ] One relevant *image* (or your favourite stats/coding meme) with a figure caption (@sec-md-images)
* [ ] *Cross reference* the image in the introduction text with automatic figure numbering (@sec-cross-references)
...
* [ ] At least two *bibliographic references* cited in the text, created and displayed in the reference section using reproducible techniques (@sec-biliography)
