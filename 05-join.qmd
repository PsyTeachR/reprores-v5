...
The University of Glasgow's Schedule A grading scheme uses a 22-point alphanumeric scale (there's more information in your summative report [assessment information sheet](https://sway.office.com/k0CnXGd6RjbVokkR)). Each alphanumeric grade (e.g., B2) has an underlying numeric Grade Point (e.g., 16). 
...
## Glossary {#sec-glossary-joines .unnumbered}

```{r, echo = FALSE}
glossary_table()
```

## Further resources {#sec-resources-joins .unnumbered}
