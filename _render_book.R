...
file.remove("docs/reprores-v4.pdf")
file.rename("docs/_main.pdf", "docs/reprores-v4.pdf")

## make EPUB ----
set.seed(8675309)
xfun::in_dir("book", bookdown::render_book("index.Rmd", "bookdown::epub_book"))
file.remove("docs/reprores-v4.epub")
file.rename("docs/_main.epub", "docs/reprores-v4.epub")

## make MOBI ----
epub <- file.path(getwd(), "docs/reprores-v4.epub")
