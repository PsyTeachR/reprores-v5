...
To get your webpage online, copy the contents of the `docs` directory to a web server. If you don't have access to a web server, you can make free websites using a GitHub repository and [GitHub Pages](https://pages.github.com/)).


## Styles {#sec-webpage-styles}

You can change the appearance of your website by changing the theme in the `_site.yml` file (see @sec-plotstyle), but the instructions below will help you to customise things even further.
