...
1. Create a new quarto file called `06-tidyr.qmd`
...
The dataset `experimentum_quests` contains questions about dogs to test the different questionnaire response types.

```{r}
experimentum_quests <- read_csv("data/experimentum_quests.csv")
```
