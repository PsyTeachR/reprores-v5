...
If you don't already have packages like `r pkg("audio")` installed, it will also install these dependencies for you. If you don't get an error message at the end, the installation was successful. 
...
devtools::install_github("psyteachr/reprores-v4")
```
...
Many packages, especially [tidyverse](https://www.tidyverse.org/packages/) ones, have helpful websites with vignettes explaining how to use their functions. Some of the vignettes are also available inside R. 
```{r, eval = FALSE}
