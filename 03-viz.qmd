...
* Combine the plot with the original version using patchwork functions.
* Write a short summary that explains why you think this plot is so bad.
* Organise your report so that this new plot is shown **after** the text summary.
...
* Set the figure size for all figures to 8 x 5.
