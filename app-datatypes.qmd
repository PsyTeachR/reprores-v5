...
```{r}
#| label: fig-excel-format-cells-e
#| echo: false
#| fig-cap: "Data types are like the categories when you format cells in Excel."
#| fig-alt: "The Excel graphical user interface showing cell type categories like General, Number, Accounting, Curr4ency, etc."
