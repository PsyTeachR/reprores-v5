...
## Intended Learning Outcomes {#sec-ilo-intro .unnumbered .ilo}
...
## Functions used {#sec-functions-intro .unnumbered}
...
## Setup {#sec-setup-intro .unnumbered}
...
This book was created using `r R.version.string` (`r R.version$nickname`) and RStudio version 2024.4.2.764 (Chocolate Cosmos). Most of the content of this book will work fine in versions of R above 4.0 and earlier versions of RStudio, although there may be some small differences in the interface.
:::
...
If you type a function into the console pane, it will run as soon as you hit enter. If you put the function in a `r glossary("script")` or `r glossary("R Markdown")` or `r glossary("quarto")` document in the `r glossary("panes", "source pane")`, it won't run until you run the script, `r glossary("knit")` the R Markdown file, or run a code `r glossary("chunk")`. You'll learn more about this in @sec-reports.
