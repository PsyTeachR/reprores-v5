...
![Screenshot of RStudio IDE showing an error indicated by the red arrow](https://raw.githubusercontent.com/PsyTeachR/FAQ/master/images/mtcars_error.jpg){fig-alt="The error is in the console pane of the RSutio IDE."}
...
![Screenshot of MS Teams with the code pasted directly in. Not pretty!](https://raw.githubusercontent.com/PsyTeachR/FAQ/master/images/teams_paste1.jpg){fig-alt="The code mtcars %>% filter(mpg > 20) is shown in plain text"}
...
![Screenshot of Teams showing the icon that looks like an "A"](https://raw.githubusercontent.com/PsyTeachR/FAQ/master/images/teams_paste2.jpg){fig-alt="The text box says 'Start a new conversation. Type @ to mention someone.' and underneath there is a red circle around the formatting icon"}
...
![A screenshot of Teams formatting icons, with code icon highlighted](https://raw.githubusercontent.com/PsyTeachR/FAQ/master/images/teams_paste3.jpg){fig-alt="The code icon looks like '</>'"}
...
![Screenshot of Teams formatting icons, with code icon highlighted](https://raw.githubusercontent.com/PsyTeachR/FAQ/master/images/teams_paste4.jpg){fig-alt="The syntax hightlighing for mtcars %>% filter(mpg > 20) shows the number 20 ina green font"}

Here is how you might begin your post. 

![Screenshot of Teams with unsubmitted post](https://raw.githubusercontent.com/PsyTeachR/FAQ/master/images/teams_paste5.jpg){fig-alt="The title is 'Error: could not find function %>%' and the contents reads 'I am getting this error when I rrun this code:', then there is a code block titled 'code that is giving me an error' and the code underneath is 'mtcars%>% filter(mpg > 20)'"}
