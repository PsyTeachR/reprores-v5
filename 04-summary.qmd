...
<img src="images/tidy/pipe_sticker.png" alt="Hexagon sticker with the magrittr pipe %>% and text in cursive below it reading 'Ceci n'est pas un pipe.'" style="width: 100%"/>
:::
