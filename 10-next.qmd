...
You can create online books with quarto. In fact, the book you're reading was created using quarto After you download the package, start a new project and choose "Quarto Book" from the list of project templates. 

Each chapter is written in a separate .qmd file and the general book settings can be changed in the `_quarto.yml` file.

::: {.try}
Create a new book project, add the .qmd files for your chapter notes and exercises, then render it as a book. What do you need to change to make this work?
:::

#### Websites

You can create a simple website the same way you create any quarto document. Choose "Quarto Website" from the project templates to get started.

For more complex, blog-style websites, you can investigate [Quarto Blogs](https://quarto.org/docs/websites/website-blog.html).

#### Shiny

To get truly interactive, you can take your R coding to the next level and learn Shiny. Shiny apps let your R code react to user input. 

<!--
You can do things like [make a word cloud](https://shiny.psy.gla.ac.uk/debruine/wordcloud/), [search a google spreadsheet](https://shiny.psy.gla.ac.uk/debruine/seen/), or [conduct a survey](https://shiny.psy.gla.ac.uk/debruine/question/).
-->
